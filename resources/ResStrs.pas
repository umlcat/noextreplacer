...
const
  resProductName      = 'No Extension Filename Replacer';
resourcestring
...
const
  resProductName      = 'Reemplazador para Nombre de Ficheros sin Extension';
resourcestring
  resTfrMain_Caption  = resProductName;
...
{$IFDEF LanguageLatam}
const
  resProductName      = 'Reemplazador para Nombre de Archivos sin Extension';
resourcestring
  resTfrMain_Caption  = resProductName;
  resTfrmAbout_Caption  = 'Acerca de ' + resProductName;
  resTfrmHelp_Caption   =
...
const
  resProductName      = 'Reemplazateur par Archives sans Archive Extension';
resourcestring
  resTfrMain_Caption  = resProductName;
